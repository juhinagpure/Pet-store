                ...
                void (cn = setTimeout(
                  function () {
                    if ((ct("initialZoom" + (o ? "Out" : "In")), o)) {
                      ...
                      m
                        ? zt("initialZoom", 0, 1, l, n.easing.cubic.out, f, c)
            ...
            for (var n = 0, i = Lt.length; n < i; n++) {
              ...
              for (var T = 0; T < f - 1; T++)
                if (l >= c[T].frame && l <= c[T + 1].frame) {
                  ...
                  S &&
                    x !== T &&
                    (wt(u, "down" === zt ? E.eventType : I.eventType, zt),
                    (o.lastFrameIndex = T));
                  break;
                }
            }
...
*/ !(function () {
  ...
  13323: function (t, e, n) {
    ...
    i(function () {
      ...
      function e(name, t, e) {
        o.get(name) || o.set(name, t, { expires: e, secure: true });
      }
      function n() {
        function t() {
        ...
        t.on("click", ".u-btn-step", function (t) {
          ...
          e.length &&
            (button.hasClass("u-btn-step-next")
              ? e[s]("next")
              : button.hasClass("u-btn-step-prev") && e[s]("prev"));
        }),
        e
